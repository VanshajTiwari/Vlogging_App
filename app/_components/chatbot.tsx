...
export default function Chatbox(){
    const TriggerBtn=useRef<HTMLDivElement>(null);
    function  handleClick(){
        TriggerBtn.current?.classList.toggle("hidden");
    }
    return (
        <div>
            <button
            ...
            <div ref={TriggerBtn} style={{boxShadow:" 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)"}}
                className="fixed z-[10000] hidden bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[604px]">

                <div className="flex flex-col space-y-1.5 pb-6">
                <h2 className="font-semibold text-lg tracking-tight">Chatbot</h2>
                <p className="text-sm text-[#6b7280] leading-3">Powered by Project IGI</p>
                </div>
                <div className="pr-4 h-[464px]" style={{minWidth: "100%", display: "table"}}>
